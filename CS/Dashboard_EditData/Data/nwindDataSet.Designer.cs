...
namespace Dashboard_EditData.Data {
    ...
    public partial class nwindDataSet : global::System.Data.DataSet {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public OrdersRow AddOrdersRow(System.DateTime OrderDate, decimal Freight) {
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Orders` WHERE ((`OrderID` = ?) AND ((? = 1 AND `OrderDate` IS NULL) " +
                "OR (`OrderDate` = ?)) AND ((? = 1 AND `Freight` IS NULL) OR (`Freight` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Orders` (`OrderDate`, `Freight`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Orders` SET `OrderDate` = ?, `Freight` = ? WHERE ((`OrderID` = ?) AND ((?" +
                " = 1 AND `OrderDate` IS NULL) OR (`OrderDate` = ?)) AND ((? = 1 AND `Freight` IS" +
                " NULL) OR (`Freight` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Dashboard_EditData.Properties.Settings.Default.nwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT OrderID, OrderDate, Freight FROM Orders";
        ...
        public virtual int Delete(int Original_OrderID, global::System.Nullable<global::System.DateTime> Original_OrderDate, global::System.Nullable<decimal> Original_Freight) {
            ...
            if ((Original_Freight.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((decimal)(Original_Freight.Value));
            }
            else {
        ...
        public virtual int Insert(global::System.Nullable<global::System.DateTime> OrderDate, global::System.Nullable<decimal> Freight) {
            ...
            if ((Freight.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[1].Value = ((decimal)(Freight.Value));
            }
            else {
        ...
        public virtual int Update(global::System.Nullable<global::System.DateTime> OrderDate, global::System.Nullable<decimal> Freight, int Original_OrderID, global::System.Nullable<global::System.DateTime> Original_OrderDate, global::System.Nullable<decimal> Original_Freight) {
            if ((OrderDate.HasValue == true)) {
            ...
            if ((Freight.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((decimal)(Freight.Value));
            }
            else {
            ...
            if ((Original_Freight.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((decimal)(Original_Freight.Value));
            }
            else {
