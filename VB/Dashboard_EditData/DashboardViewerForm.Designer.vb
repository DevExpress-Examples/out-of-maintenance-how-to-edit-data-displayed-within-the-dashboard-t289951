Namespace Dashboard_EditData
	Partial Public Class DashboardViewerForm
		...
		Private Sub InitializeComponent()
			...
			Me.ribbonControl1.Size = New System.Drawing.Size(630, 143)
			' 
			' barButtonItem1
			' 
			Me.barButtonItem1.Caption = "Edit Underlying Data"
			Me.barButtonItem1.Id = 1
			Me.barButtonItem1.ImageOptions.ImageUri.Uri = "Edit"
...
'ORIGINAL LINE: this.barButtonItem1.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItem1_ItemClick);
			...
			Me.barButtonItem2.ImageOptions.Image = (DirectCast(resources.GetObject("barButtonItem2.ImageOptions.Image"), System.Drawing.Image))
...
'ORIGINAL LINE: this.barButtonItem2.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItem2_ItemClick);
			...
			Me.dashboardViewer1.Size = New System.Drawing.Size(630, 332)
			Me.dashboardViewer1.TabIndex = 1
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.dashboardViewer1.DashboardItemClick += new DevExpress.DashboardWin.DashboardItemMouseActionEventHandler(this.dashboardViewer1_DashboardItemClick);
			' 
			' DashboardViewerForm
			' 
