...
Namespace Dashboard_EditData.Data
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class OrdersDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>
			Public Function AddOrdersRow(ByVal OrderDate As Date, ByVal Freight As Decimal) As OrdersRow
				Dim rowOrdersRow As OrdersRow = (DirectCast(Me.NewRow(), OrdersRow))
				Dim columnValuesArray() As Object = { Nothing, OrderDate, Freight}
	...
	End Class
End Namespace
Namespace Dashboard_EditData.Data.nwindDataSetTableAdapters
	...
	Partial Public Class OrdersTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Orders` WHERE ((`OrderID` = ?) AND ((? = 1 AND `OrderDate` IS NULL) " & "OR (`OrderDate` = ?)) AND ((? = 1 AND `Freight` IS NULL) OR (`Freight` = ?)))"
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Orders` (`OrderDate`, `Freight`) VALUES (?, ?)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Orders` SET `OrderDate` = ?, `Freight` = ? WHERE ((`OrderID` = ?) AND ((?" & " = 1 AND `OrderDate` IS NULL) OR (`OrderDate` = ?)) AND ((? = 1 AND `Freight` IS" & " NULL) OR (`Freight` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT OrderID, OrderDate, Freight FROM Orders"
		...
		Public Overridable Function Delete(ByVal Original_OrderID As Integer, ByVal Original_OrderDate? As Global.System.DateTime, ByVal Original_Freight? As Decimal) As Integer
			...
			If (Original_OrderDate.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(2).Value = (CDate(Original_OrderDate.Value))
			Else
			...
			If (Original_Freight.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(4).Value = (CDec(Original_Freight.Value))
			Else
		...
		Public Overridable Function Insert(ByVal OrderDate? As Global.System.DateTime, ByVal Freight? As Decimal) As Integer
			If (OrderDate.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(0).Value = (CDate(OrderDate.Value))
			Else
				Me.Adapter.InsertCommand.Parameters(0).Value = Global.System.DBNull.Value
			End If
			If (Freight.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(1).Value = (CDec(Freight.Value))
			Else
		...
		Public Overridable Function Update(ByVal OrderDate? As Global.System.DateTime, ByVal Freight? As Decimal, ByVal Original_OrderID As Integer, ByVal Original_OrderDate? As Global.System.DateTime, ByVal Original_Freight? As Decimal) As Integer
			If (OrderDate.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(0).Value = (CDate(OrderDate.Value))
			Else
				Me.Adapter.UpdateCommand.Parameters(0).Value = Global.System.DBNull.Value
			End If
			If (Freight.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(1).Value = (CDec(Freight.Value))
			Else
			...
			If (Original_OrderDate.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(4).Value = (CDate(Original_OrderDate.Value))
			Else
			...
			If (Original_Freight.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(6).Value = (CDec(Original_Freight.Value))
			Else
