Namespace Dashboard_EditData
	Partial Public Class UnderlyingDataForm
		...
		Private Sub InitializeComponent()
			...
			Me.gridControl1.Size = New System.Drawing.Size(569, 321)
...
'ORIGINAL LINE: this.gridView1.RowUpdated += new DevExpress.XtraGrid.Views.Base.RowObjectEventHandler(this.gridView1_RowUpdated);
			' 
			' colOrderID
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.Load += new System.EventHandler(this.UnderlyingDataForm_Load);
